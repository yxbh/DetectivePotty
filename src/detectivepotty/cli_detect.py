"""Detection-oriented CLI commands."""
...
def register_detect_commands(app: typer.Typer) -> None:
    app.command("detect-file")(detect_file)
...
def _draw_detections(frame: Any, detections: list[object]) -> None:
    import cv2
