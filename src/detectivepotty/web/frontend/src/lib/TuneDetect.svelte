<script lang="ts">
  ...
  import TuneScenePanel from "./TuneScenePanel.svelte";
  import TuneTimelineStrip from "./TuneTimelineStrip.svelte";
  import TuneTrackPanel from "./TuneTrackPanel.svelte";
  import TuneZoomColumn from "./TuneZoomColumn.svelte";
  ...
  let zoomCanvases = $state<HTMLCanvasElement[]>([]);
...
<div class="tune" class:has-zoom={selectedPath && showZoom}>
    ...
    {:else}
      <div class="player">
        ...
        <TuneTrackPanel
          ...
          {trackError}
          {trackStats}
          bind:trackSampleEvery
          bind:trackIou
          bind:trackMaxAge
          bind:trackCenterGate
          bind:ultraConf
          bind:ultraTrackHigh
          bind:ultraTrackLow
          bind:ultraNewTrack
          bind:ultraTrackBuffer
          bind:ultraMatch
          bind:ultraProximity
          bind:ultraAppearance
          ontracker={setTracker}
          oninvalidate={invalidateButtonDrivenTrack}
          onruntrack={runTrackRange}
          oncanceltrack={cancelTrackRange}
        />
  ...
  {#if selectedPath && showZoom}
    <TuneZoomColumn {zoomCards} bind:canvases={zoomCanvases} />
  {/if}
</div>
